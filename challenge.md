...
platform. You can download the design file on the platform. **Please be sure not to share them with anyone else.** The
design download comes with a `challenge.md` file as well to help you get set up.
...
**Note:** These files are designed to help you *learn*, not to do the work for you. The AI is instructed to ask
...
providers. [Read more about our recommended and trusted hosts](https://www.frontendmentor.io/guides/hosting-your-solution).

## Create a custom `challenge.md`

We strongly recommend overwriting this `challenge.md` with a custom one. We've provided a template inside the [
`README.md`](README.md) file in this starter code.
...
Once you've added your information to the template, delete this file and rename the `README.md` file to `challenge.md`.
...
our ["Complete guide to submitting solutions"](https://www.frontendmentor.io/guides/how-to-submit-solutions) for tips on
how to do this.
...
2. Share on [X (formerly Twitter)](https://x.com/frontendmentor) and mention **@frontendmentor**, including the repo and
   live URLs in your post. We'd love to take a look at what you've built and help share it around.
